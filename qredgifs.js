...
document.addEventListener("DOMContentLoaded", () => {  
    ...
    bottomUI.innerHTML = `  
        ...
        <div class="rg-action-row rg-pointer">  
            <!-- Playback & Audio -->  
            <button class="rg-action-btn rg-speed-text" id="ui-btn-speed" title="Playback Speed">1x</button>  
            ...
            <button class="rg-action-btn" id="ui-btn-share" title="Share"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="5" r="3"></circle><circle cx="6" cy="12" r="3"></circle><circle cx="18" cy="19" r="3"></circle><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"></line><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"></line></svg></button>  
            <button class="rg-action-btn" id="ui-btn-download" title="Download"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg></button>  
            <button class="rg-action-btn" id="ui-btn-soundtrack" title="Soundtrack / Audio Info"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18V5l12-2v13"></path><circle cx="6" cy="18" r="3"></circle><circle cx="18" cy="16" r="3"></circle></svg></button>  
            ...
            <!-- Navigation & Discovery (.ApplicationFooter-Container Integrations) -->  
            <button class="rg-action-btn" id="ui-btn-feed" title="Home / Discover"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg></button>  
            <button class="rg-action-btn" id="ui-btn-trending" title="Trending"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline><polyline points="17 6 23 6 23 12"></polyline></svg></button>  
            <button class="rg-action-btn" id="ui-btn-search" title="Search"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg></button>  
            <button class="rg-action-btn" id="ui-btn-upload" title="Upload"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="17 8 12 3 7 8"></polyline><line x1="12" y1="3" x2="12" y2="15"></line></svg></button>  
            <button class="rg-action-btn" id="ui-btn-profile" title="My Profile"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg></button>  
    ...
    document.getElementById('ui-btn-download').onclick = () => {  
        const activeVid = getActiveVideoFromCenter();  
        if (activeVid && activeVid.src) {  
            const a = document.createElement('a');  
            a.href = activeVid.src;  
            a.download = 'redgifs_video.mp4';  
    ...
    document.getElementById('ui-btn-soundtrack').onclick = () => {  
        const activeVid = getActiveVideoFromCenter();  
        const container = activeVid?.closest('.Feed-Item, .VideoPlayer') || document;  
        const soundInfo = container.querySelector('.AudioTrackName, [class*="Sound"], [class*="audio"]');  
        if (soundInfo && soundInfo.textContent.trim()) {  
            showToast(`Audio: ${soundInfo.textContent.trim()}`);  
        } else {  
            showToast("No soundtrack info available");  
        }  
    };  

    document.getElementById('ui-btn-trending').onclick = () => { window.location.href = '/trending'; };  
    document.getElementById('ui-btn-search').onclick = () => { window.location.href = '/search'; };  
    document.getElementById('ui-btn-upload').onclick = () => { window.location.href = '/upload'; };  
    document.getElementById('ui-btn-profile').onclick = () => {  
        const activeVid = getActiveVideoFromCenter();  
        const container = activeVid?.closest('.Feed-Item, .VideoPlayer') || document;  
